                                ...
                                <thead>
                                    ...
                                    @forelse($pendingOrders as $order)
                                        <tr>
                                                ...
                                                <td class="cell">
                                                    <a class="btn-sm app-btn-secondary" href="{{ route('each.user', $order->order_id)}}">Measurement</a>
                                                    </td>
												<td class="cell"><span class="badge bg-warning fs-6">{{ $order->status }}</span></td>
												<td class="cell">{{ $order->total_price }}</td>
                                                <td class="cell">
                                                    <a class="btn-sm app-btn-secondary" href="{{ route('view.user.pendding', $order->order_id ) }}">View</a>

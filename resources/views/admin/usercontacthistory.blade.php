...
<head>
    ...
    <title>@section('title') User Contacts @endsection</title>
    ...
    <link href="{{ asset('css/bootstrap.min.css') }}" rel="stylesheet">
     <style>
        ...
        .contact-header {
            background: linear-gradient(135deg, #0d32edff, #6586b7ff);
            color: white;
            padding: 15px;
            font-size: 1.2rem;
            display: flex;
...
<div class="container mt-5">
    <h1 class="text-center mb-4 mt-5">📩 Contact Submissions</h1>
